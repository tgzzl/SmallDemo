...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                UIUtils.showToast(getContext(), "Hello World! T");
            }
        });
...
//        new UpgradeManager2(getContext()).checkUpgrade();
    }

    private static class UpgradeManager2 {
        ...
        public UpgradeManager2(Context context) {
            mContext = context;
        }

        public void checkUpgrade() {
            Log.d("test", "BundleVersions:" + Small.getBundleVersions());
            mProgressDlg = ProgressDialog.show(mContext, "Small", "Checking for updates...");
            mProgressDlg.setMessage("Upgrading...");

            String pluginName = "net.wequick.example.small.lib.utils";
            final net.wequick.small.Bundle bundle = net.wequick.small.Bundle.findByName(pluginName);
            Log.d("test", "Bundle:" + bundle);
            upgradeBundle(bundle, "lib" + pluginName.replace('.', '_') + ".so", bundle.getPatchFile(),
                    new OnUpgradeListener() {
                        ...
                        public void onUpgrade() {
                            ...
                            Toast.makeText(mContext,
                                    "Test Upgrade Success! Restart and Click `Call lib.utils` to see changes.",
        ...
        private void upgradeBundle(final net.wequick.small.Bundle bundle,
                                   final String url, final File file,
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        InputStream is = new FileInputStream(Environment.getExternalStorageDirectory() + "/" + url);
                        // Save
        ...
        public void checkUpgrade() {
            ...
            requestUpgradeInfo(Small.getBundleVersions(), new OnResponseListener() {
                ...
                public void onResponse(Object object) {
                    ...
                    mProgressDlg.setMessage("Test Upgrading...");
